...
const Passport = () => {
  ...
  const [data, setData] = useState(governmentIdInfo["passportFileNumber"] ? [{ number: governmentIdInfo?.passportFileNumber }] : []);
  const [isModalVisible, setModalVisible] = useState(governmentIdInfo["passportFileNumber"] ? false : true);
