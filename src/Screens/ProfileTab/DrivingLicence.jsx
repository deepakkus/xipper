...
const DrivingLicence = () => {
  ...
  const [data, setData] = useState(governmentIdInfo["drivingLicenseNumber"] ? [{ number: governmentIdInfo?.drivingLicenseNumber }] : []);
  const [isModalVisible, setModalVisible] = useState(governmentIdInfo["drivingLicenseNumber"] ? false : true);
