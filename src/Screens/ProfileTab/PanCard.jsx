...
const PanCard = () => {
  ...
  const [data, setData] = useState(governmentIdInfo["panNumber"] ? [{ number: governmentIdInfo?.panNumber }] : []);
  const [isModalVisible, setModalVisible] = useState(governmentIdInfo["panNumber"] ? false : true);
